...
//     // TODO: One time test cleanpu
//     //process.once('whatever teh shutdown signal(s) is', cleanup);

//     // mocha kill signal - research...
//     process.on('SIG__', function() {
//       if (client) {
//         client.rollback();
//       }
//     });
...
//       };
//       client.query(test1Data.query, test1Data.values, function(err, result) {
//         expect(err).to.be.null;
//         console.dir(result);
